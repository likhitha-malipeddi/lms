...
LibrarySerializer, BookSerializer, AuthorSerializer, CategorySerializer, BookAuthorSerializer, MemberSerializer, BorrowingSerializer, ReviewSerializer
)
    ...
    def get_queryset(self):
        ...
        return(
            ...
            .filter(
                ...
                | Q(bookauthor_author_name=query)
